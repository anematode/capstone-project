...
if (usePreloaded)  {
  ...
  tileLoader = new TilesetLoader(64)
}
...
export const tileset = window.tileset = tileLoader.tileset
...
export const texturePack = window.texturePack = texturePacker.texturePack
